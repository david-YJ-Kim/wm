...
@Data
public class WfsVmsProdStartedIvo extends ApMsgCommonVo {

	public static String system = ApSystemCodeConstant.WFS;
	public static String cid = WorkManMessageList.WFS_VMS_PROD_STARTED;


	private WfsVmsProdStartedBody body;

	@Data
	public static class WfsVmsProdStartedBody extends ApMsgBody{
		String subEqpId;
		String procDefId;
		String procSgmtId;
		String ppId;
