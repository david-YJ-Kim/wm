...
import com.abs.wfs.workman.service.flow.eap.WfsPanelMoveOut;
...
@Service
@Slf4j
public class WfsPanelMoveOutImpl implements WfsPanelMoveOut {
    ...
    @Override
    public ApFlowProcessVo execute(ApFlowProcessVo apFlowProcessVo, WfsPanelMoveOutIvo wfsPanelMoveOutIvo) throws Exception {

        WfsPanelMoveOutIvo.Body body = wfsPanelMoveOutIvo.getBody();
        ...
        log.info("{} Set up message body: {}", apFlowProcessVo.printLog(), wfsPanelMoveOutIvo.toString());
        ...
        cnPosProdMtrlMove.setEqpImportDt(null);
        cnPosProdMtrlMove.setProdStartDt(null);
        cnPosProdMtrlMove.setProdEndDt(null);
        cnPosProdMtrlMove.setEqpExportDt(null);
        cnPosProdMtrlMove.setCarrInDt(null);
