...
import com.abs.wfs.workman.service.flow.eap.WfsEqpPanelExport;
...
@Service
@Slf4j
public class WfsEqpPanelExportImpl implements WfsEqpPanelExport {
    ...
    @Override
    public ApFlowProcessVo execute(ApFlowProcessVo apFlowProcessVo, WfsEqpPanelExportIvo wfsEqpPanelExportIvo) throws Exception {
        WfsEqpPanelExportIvo.Body body = wfsEqpPanelExportIvo.getBody();
        ...
        log.info("{} Set up message body: {}", apFlowProcessVo.printLog(), wfsEqpPanelExportIvo.toString());
        ...
        if(optProdMtrl.isPresent()) {
            ...
            throw new ScenarioException(apFlowProcessVo, body, ApExceptionCode.WFS_ERR_LOT_INF_NOTFOUND, apFlowProcessVo.getLang(), new String[] {body.getLotId(), body.getProdMtrlId()});
        }
