...
import com.abs.wfs.workman.service.flow.eap.WfsPanelMoveIn;
...
@Service
@Slf4j
public class WfsPanelMoveInImpl implements WfsPanelMoveIn {
    ...
    @Override
    public ApFlowProcessVo execute(ApFlowProcessVo apFlowProcessVo, WfsPanelMoveInIvo wfsPanelMoveInIvo) throws Exception {
        WfsPanelMoveInIvo.Body body = wfsPanelMoveInIvo.getBody();
        ...
        log.info("{} Set up message body: {}", apFlowProcessVo.printLog(), wfsPanelMoveInIvo.toString());
        ...
        cnPosProdMtrlMove.setEvntNm(wfsPanelMoveInIvo.getHead().getCid());
        cnPosProdMtrlMove.setTid(wfsPanelMoveInIvo.getHead().getTid());

        cnPosProdMtrlMove.setPrevCstmEvntNm(cnPosProdMtrlMove.getCstmEvntNm());
        cnPosProdMtrlMove.setCstmEvntNm(PanelMoveCode.ProdCarrIn.toString());
