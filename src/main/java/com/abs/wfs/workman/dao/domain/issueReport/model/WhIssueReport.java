...
@Getter
@Setter
@Entity(name = "WH_ISSUE_REPORT")
public class WhIssueReport {

    @Id
    @GenericGenerator(name = "WH_ISSUE_REPORT_SEQ_GENERATOR", strategy = "com.abs.wfs.workman.util.ObjIdGenerator")
    @GeneratedValue(generator = "WH_ISSUE_REPORT_SEQ_GENERATOR")
    @Column(name = "OBJ_ID")
    ...
    @Builder
    public WhIssueReport(String objId, String refObjId, String siteId, String trkId, String cid, String payload, WorkStatCd workStatCd, String scenarioTyp, UseYn fixedYn, UseYn sysFixedYn, Timestamp fixedDt, String lotId, String carrId, String eqpId, String portId, String errCd, String errCm, String evntNm, String prevEvntNm, String cstmEvntNm, String prevCstmEvntNm, UseStatCd useStatCd, String rsnCd, String trnsCm, String crtUserId, Timestamp crtDt, String mdfyUserId, Timestamp mdfyDt, Timestamp fnlEvntDt, String tid) {
        this.objId = objId;
