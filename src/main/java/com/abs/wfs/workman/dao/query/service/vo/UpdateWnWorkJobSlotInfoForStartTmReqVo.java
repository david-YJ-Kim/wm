...
@Data
public class UpdateWnWorkJobSlotInfoForStartTmReqVo {
    String siteId;
    String cid;
    String tid;
    String userId;
    ...
    @Builder
    public UpdateWnWorkJobSlotInfoForStartTmReqVo(ApFlowProcessVo vo, String workId, String jobSeqId, String prodMtrlId, String slotNo) {
