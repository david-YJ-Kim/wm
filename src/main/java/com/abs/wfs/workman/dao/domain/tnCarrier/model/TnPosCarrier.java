...
public class TnPosCarrier {
    ...
    @Id
    @GenericGenerator(name = "TN_POS_CARRIER_SEQ_GENERATOR", strategy = "com.abs.wfs.workman.util.ObjIdGenerator")
    @GeneratedValue(generator = "TN_POS_CARRIER_SEQ_GENERATOR")
