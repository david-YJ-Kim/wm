...
@Getter
@Setter
@Entity(name = "WH_WORK_STAT")
@DynamicInsert
@DynamicUpdate
@Cacheable(false)
public class WhWorkStat {

    @Id
    @GenericGenerator(name = "WH_WORK_STAT_SEQ_GENERATOR", strategy = "com.abs.wfs.workman.util.ObjIdGenerator")
    @GeneratedValue(generator = "WH_WORK_STAT_SEQ_GENERATOR")
