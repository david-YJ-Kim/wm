...
@Getter
@Setter
@Entity(name = "WH_SORTER_JOB_RESV")
@DynamicInsert
@DynamicUpdate
@Cacheable(false)
public class WhSorterJobResv {

    @Id
    @GenericGenerator(name = "WH_SORTER_JOB_RESV_SEQ_GENERATOR", strategy = "com.abs.wfs.workman.util.ObjIdGenerator")
    @GeneratedValue(generator = "WH_SORTER_JOB_RESV_SEQ_GENERATOR")
