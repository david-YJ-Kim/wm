...
public class TnPosPortDto {
    ...
    public String getpEqpId() {
        return pEqpId;
    }

    public void setpEqpId(String pEqpId) {
        this.pEqpId = pEqpId;
    }
    ...
    public void setpPortId(String pPortId) {
        this.pPortId = pPortId;
    }
    ...
    public String getEfemStatCd() {
        return efemStatCd;
    }

    public void setEfemStatCd(String efemStatCd) {
        this.efemStatCd = efemStatCd;
    }

    public String getEfemCtrlModeCd() {
        return efemCtrlModeCd;
    }
