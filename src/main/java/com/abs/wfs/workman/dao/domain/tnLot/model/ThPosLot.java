...
@Getter
@Setter
@Entity(name = "TH_POS_LOT")
@DynamicInsert
@DynamicUpdate
@Cacheable(false)
public class ThPosLot {

    @Id
    @GenericGenerator(name = "TH_POS_LOT_SEQ_GENERATOR", strategy = "com.abs.wfs.workman.util.ObjIdGenerator")
    @GeneratedValue(generator = "TH_POS_LOT_SEQ_GENERATOR")
    private String objId;
    private String refObjId;
    private String siteId;
    private String lotId;
    private String loTHm;
    ...
    private String evnTHm;
    private String prevEvnTHm;
    private String cstmEvnTHm;
    private String prevCstmEvnTHm;
