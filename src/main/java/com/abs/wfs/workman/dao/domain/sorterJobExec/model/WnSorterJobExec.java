...
@Getter
@Setter
@Entity(name = "WN_SORTER_JOB_EXEC")
@DynamicInsert
@DynamicUpdate
@Cacheable(false)
public class WnSorterJobExec {
    ...
    @Id
    @GenericGenerator(name = "WN_SORTER_JOB_EXEC_SEQ_GENERATOR", strategy = "com.abs.wfs.workman.util.ObjIdGenerator")
    @GeneratedValue(generator = "WN_SORTER_JOB_EXEC_SEQ_GENERATOR")
