...
@Getter
@Setter
@Entity(name = "WH_DSP_WORK_INFO")
@DynamicInsert
@DynamicUpdate
@Cacheable(false)
public class WhDspWorkInfo {

    @Id
    @GenericGenerator(name = "WH_DSP_WORK_INFO_SEQ_GENERATOR", strategy = "com.abs.wfs.workman.util.ObjIdGenerator")
    @GeneratedValue(generator = "WH_DSP_WORK_INFO_SEQ_GENERATOR")
