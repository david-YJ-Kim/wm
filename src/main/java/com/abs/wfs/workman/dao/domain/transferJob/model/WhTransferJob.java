...
public class WhTransferJob {
    ...
    @Id
    @GenericGenerator(name = "WH_TRANSFER_JOB_SEQ_GENERATOR", strategy = "com.abs.wfs.workman.util.ObjIdGenerator")
    @GeneratedValue(generator = "WH_TRANSFER_JOB_SEQ_GENERATOR")
