...
@Getter
@Setter
@Entity(name = "TH_RDS_PORT")
@DynamicInsert
@DynamicUpdate
@Cacheable(false)
public class ThRdsPort {

    @Id
    @GenericGenerator(name = "TH_RDS_PORT_SEQ_GENERATOR", strategy = "com.abs.wfs.workman.util.ObjIdGenerator")
    @GeneratedValue(generator = "TH_RDS_PORT_SEQ_GENERATOR")
