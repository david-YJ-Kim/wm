...
@Getter
@Setter
@Entity(name = "WN_SORTER_JOB_SLOT_INFO")
@DynamicInsert
@DynamicUpdate
@Cacheable(false)
public class WnSorterJobSlotInfo {
    ...
    @Id
    @GenericGenerator(name = "WN_SORTER_JOB_SLOT_INFO_SEQ_GENERATOR", strategy = "com.abs.wfs.workman.util.ObjIdGenerator")
    @GeneratedValue(generator = "WN_SORTER_JOB_SLOT_INFO_SEQ_GENERATOR")
